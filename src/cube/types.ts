 ...
 *   6 7 8
 */
export type FaceArray = readonly [Color, Color, Color, Color, Color, Color, Color, Color, Color];

/**
 * Cube interface with all six faces explicitly defined
 */
export interface Cube {
  readonly U: FaceArray; // Up (White)
  readonly R: FaceArray; // Right (Red)
  readonly F: FaceArray; // Front (Green)
  readonly D: FaceArray; // Down (Yellow)
  readonly L: FaceArray; // Left (Orange)
  readonly B: FaceArray; // Back (Blue)
}
