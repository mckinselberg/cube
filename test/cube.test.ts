...
describe('Cube', () => {
  it('should create a solved cube', () => {
    ...
    expect(cube.U).toEqual(['W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W']);
    expect(cube.R).toEqual(['R', 'R', 'R', 'R', 'R', 'R', 'R', 'R', 'R']);
    expect(cube.F).toEqual(['G', 'G', 'G', 'G', 'G', 'G', 'G', 'G', 'G']);
    expect(cube.D).toEqual(['Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y']);
    expect(cube.L).toEqual(['O', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'O']);
    expect(cube.B).toEqual(['B', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B']);
  });
  ...
  it('should clone a cube without mutation', () => {
    ...
    expect(cloned.U).not.toBe(original.U);
  });
